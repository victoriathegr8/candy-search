...
export function MakeForm(props) {
  ...
  return (<RenderForm props={props}/>);
 
}


export function RenderForm (props) {
  console.log("props inside RenderForm", props);
  return (
  <form>
    <h2>Filter</h2>
    ...
    <button id="applybutton" type="button" onClick={function() {console.log("you clicked me"); props.props.handleSubmit() }} >Apply</button>
