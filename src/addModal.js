    ...
    return (
        <div className="modal add-modal card">
            <div className="modal-content card-body">
                ...
                <label for="containsChocolate">Your Candy contains Chocolate</label>
                <br/>
                <input type="checkbox" name="fruity" onClick={() => {candy.fruity = 1}}></input>
                <label for="fruity">Your Candy is Fruity</label>
                <br/>
                <input type="checkbox" name="caramel" onClick={() => {candy.caramel = 1}}></input>
                <label for="caramel">Your Candy contains caramel</label>
                <br/>
                <input type="checkbox" name="peanutyalmondy" onClick={() => {candy.peanutyalmondy = 1}}></input>
                <label for="peanutyalmondy">Your Candy contains peanuts, almonds, or peanut butter</label>
                <br/>
                <input type="checkbox" name="nougat" onClick={() => {candy.nougat = 1}}></input>
                <label for="nougat">Your Candy has nougat</label>
                <br/>
                <input type="checkbox" name="crispedricewafer" onClick={() => {candy.crispedricewafer = 1}}></input>
                <label for="crispedricewafer">Your Candy contains crisped rice wafers</label>
                <br/>
                <input type="checkbox" name="hard" onClick={() => {candy.hard = 1}}></input>
                <label for="hard">Your Candy contains is hard</label>
                <br/>
                <input type="checkbox" name="bar" onClick={() => {candy.bar = 1}}></input>
                <label for="bar">Your Candy is a bar</label>
                <br/>
                <input type="checkbox" name="pluribus" onClick={() => {candy.pluribus = 1}}></input>
                <label for="pluribus">Your Candy has many peices inside 1 box</label>
                <br/>

                <label for="sugarpercent">Sugar percentage of your Candy __% (if known): </label>
